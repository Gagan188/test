...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Name_name'), 'GG')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Country_country'), 'GG')

WebUI.click(findTestObject('Object Repository/Page_STORE/form_Total 360                          Nam_7dde31'))

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_City_city'), 'HH')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Credit card_card'), '12345')
...
WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Month_month'), '04')

WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Year_year'), '2022')
