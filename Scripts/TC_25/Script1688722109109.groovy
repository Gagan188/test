...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_Accepted usernames are                s_40dcc1'))
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Swag Labs/div_Password for all users                s_477655'))
...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_All Items_bm-overlay'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/button_Open Menu'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/nav_All ItemsAboutLogoutReset App State'))
