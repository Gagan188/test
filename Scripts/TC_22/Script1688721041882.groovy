...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Time at WorkPunched OutPunched Out Toda_a3e5b9'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/svg_Today_oxd-icon'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Edit'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_password'), 'hh')
